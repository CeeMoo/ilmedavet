...
$array_tema_part=array('static/control.php','../templates/static/head.php');

	if(session('login') && session('login') == true && session('rutbe') == 2){
		if(!empty(g('sayfa'))){
			$sayfalarimiz=array('uye', 'makaleler', 'cikis');
